...
def time_it(func, parms):
    ...
    total_time_minutes = (total_time.seconds % 3600) // 60
    total_time_seconds = (total_time.seconds % 3600) % 60

    return _mk_msg(total_time_days, total_time_hours, total_time_minutes, total_time_seconds)
